...
def mail():
    ret = True
    try:
        ver = r.randint(100000, 999999)
        msg = MIMEText(f'Your verification code is {ver}.', 'plain', 'utf-8')
        # 括号里的对应发件人邮箱昵称、发件人邮箱账号
        msg['From'] = formataddr(["Harvard University", my_sender])
        ...
        server.login(my_sender, my_pass)  # 账号密码
